...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/delivery/delivery.rule.js?${version}"></script>
    ...
    <div id="main" class="clearfix" style="">
		...
		<form method="post" action="" id="ruleForm">
			<ul class="tab clearfix">
				<li  class="now"><a href="${ctx}/delivery/ruleSet">默认设置</a></li>
				<li><a href="${ctx}/delivery/ruleCustomSet">个性化设置</a></li>
			</ul>
			<div class="ribbon clearfix">
				<div class="note">
					<p>对收件域的投递进行整体的默认规则配置</p>
				</div>
			</div>
