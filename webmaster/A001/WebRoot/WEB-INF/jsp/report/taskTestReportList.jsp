  ...
  <body>
	...
	<h1 class="title"><!-- <span class="search_top f_r"><a class="search_hide" href="javascript:void(0)">查找</a></span> -->任务发送统计&nbsp;<span></span></h1>
		...
		<ul class="tab clearfix">
			...
			<li class="now"><a href="${ctx}/taskReport/list?type=1">测试任务</a></li>
<%-- 			<li><a href="${ctx}/taskReport/apiList">API触发</a></li> --%>
		...
		<div class="ribbon clearfix">
			...
			<ul class="btn">
				...
				<li>
					<input type="button" class="groovybutton" value="导 出" title="导出" onclick="exportTaskStatNew('${ctx}/taskReport/exportTaskStatNew?type=1')">
				</li>
				<li>
