  ...
  <body>
    <div class="a4" align="center">
		...
		<table width="100%" border="0" cellspacing="0" style="table-layout:fixed;">
				...
				<c:forEach items="${recordList}" var="d" varStatus="i">
				<tr>
					<td style="word-break: break-all; word-wrap:break-word;"><span class="a_link">${d.companyName}</span></td>
					...
					<td><span class="num">${d.afterNoneCount}</td>
				</tr>
			</c:forEach>
