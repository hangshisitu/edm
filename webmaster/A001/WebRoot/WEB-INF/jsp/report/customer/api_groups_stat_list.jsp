...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/report/customer/customer.report.apigroups.list.js?${version}"></script>
  ...
  <body>
    <div id="main" class="clearfix" style="position:relative">
		...
		<form id="ListForm" action="${ctx}/customerReport/apiGroupsStatList" method="get">
			...
			<ul class="tab clearfix">
				...
				<li class="now"><a href="${ctx}/customerReport/apiGroupsStatList">API群发类</a></li>
			</ul>
			<div class="ribbon clearfix">
				...
				<ul class="btn">
					<li>
						<input type="button" class="groovybutton" value="导 出" title="导出" onclick="exportStatApiGroups('${ctx}/customerReport/exportUserApiGroups')">
					</li>
				</ul>
			</div>
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="main_table">
				<tbody>
					...
					<tr>
						...
						<td class="edit">
							<ul class="f_ul">
								<li><a href="javascript:customerTaskDetail('${ctx}/customerReport/apiGroupsTaskStatList?corpId=${r.corpId}')">报告</a></li>
							</ul>
						</td>
					</tr>
				</c:forEach>
			...
			<!-- 0，1 单项与测试任务 -->
		<input type="hidden" name="typeStr" id="typeStr" value="4">
		</form>
		<input type="hidden" name="msg" id="msg" value="${message}">
		<input type="hidden" name="listUrl" id="listUrl" value="${ctx}/customerReport/apiGroupsStatList">
		<br />
	<br />
	<br />
	</div>
