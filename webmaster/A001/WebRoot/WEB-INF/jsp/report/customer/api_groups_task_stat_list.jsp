...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/report/customer/customer.report.stat.apigroups.list.js?${version}"></script>
  ...
  <body>
    <div id="main" class="clearfix" style="position:relative">
		...
		<form id="ListForm1" action="${ctx}/customerReport/apiGroupsTaskStatList" method="get">
				...
				<li style="width:10%">
					<select id="search_emailDomain"
							name="search_emailDomain" style="width:100%;background-color: #F5F5F5">
								...
								<option <c:if test="${search_emailDomain=='mm.com'}">selected="selected"</c:if> value="mm.com">mm邮箱</option>
					</select>
				</li>
				<li>创建时间</li>
				<li>
		...
		<div class="ribbon clearfix">
			...
			<ul class="btn">
				<li>
					<input type="button" class="groovybutton" value="返 回" title="返回" onclick="back('${ctx}/customerReport/apiGroupsStatList')">
				</li>
	...
	<h1 class="title"><!-- <span class="search_top f_r"><a class="search_hide" href="javascript:void(0)">查找</a></span> -->&nbsp;<span></span></h1>
		<form id="ListForm" action="${ctx}/customerReport/apiGroupsTaskStatList" method="get">
			<%--<ul class="search clearfix m_b00 no_display">--%>
				<ul class="search clearfix m_b10">
				<li>任务名称</li>
				<li>
				...
				<li>创建时间</li>
				<li>
					<input maxlength="10" class="date" id="d5311"  name="search_beginTimeStr" value="${search_beginTimeStr}" class="Wdate" type="text" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'d4312\')}'})"/>
				</li>
				<li style="width:3%">到</li>
				<li>
				...
				<li>
					<%--<input type="button" class="groovybutton" value="重 置" title="重置" onclick="resetParam2()">
				--%></li>
			</ul>
		...
		<div class="ribbon clearfix">
			...
			<ul class="btn">
				...
				<li>
					<input type="button" class="groovybutton" value="导 出" title="导出" onclick="exportTaskStatNew('${ctx}/taskReport/exportTaskStatApiGroups','${corpId}')">
				</li>
				<li>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="main_table">
			<tbody>
				...
				<tr>
					...
					<td class="edit">
						<ul class="f_ul">
							<li><a href="javascript:report('${ctx}/taskDetailStat/overview?taskId=${r.taskId}')">报告</a></li>
						</ul>
					</td>
				</tr>
			</c:forEach>
		...
		<input type="hidden" name="userId" id="userId" value="${userId}">
		<input type="hidden" name="corpId" id="corpId" value="${corpId}">
		<input type="hidden" name="fromFlag" id="fromFlag" value="apiGroupsByUser">
	</form>
		<input type="hidden" name="msg" id="msg" value="${message}">
		<input type="hidden" name="listUrl" id="listUrl" value="${ctx}/customerReport/apiGroupsTaskStatList">
		<br />
	<br />
	<br />
	</div>
