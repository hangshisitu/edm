...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/report/senderDomainList.js?${version}"></script>
 	
  </head>
  
  <body>
    <div id="main" class="clearfix" style="position:relative">
	<h1 class="title"><!-- <span class="search_top f_r"><a class="search_hide" href="javascript:void(0)">查找</a></span> -->域名发送总览&nbsp;<span></span></h1>
		<form id="ListForm" action="${ctx}/senderDomain/list" method="get">
			<%--<ul class="search clearfix m_b00 no_display">--%>
				<ul class="search clearfix m_b10">
				<li>发件人域名</li>
				<li>
					<input maxlength="20" type="text" id="search_senderEmail" name="search_senderEmail" value="${search_senderEmail}">
				</li>
				<li>创建时间</li>
				<li>
				...
				<li>
					<%--<input onmouseover="this.style.cursor='pointer';this.style.cursor='hand';this.style.color='blue'" onmouseout="this.style.color=''"  type="button" value="查 询" onclick="search()">
					--%><input type="button" class="groovybutton" value="查 询" title="查询" onclick="search()">
				</li>
				<li>
					<%--<input onmouseover="this.style.cursor='pointer';this.style.cursor='hand';this.style.color='blue'" onmouseout="this.style.color=''"  type="button" value="重 置" onclick="resetParam()">
		...
		<ul class="tab clearfix">
			<li class="now"><a href="javascript:void(0)">按发件人域名统计</a></li>
		</ul>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="main_table">
			<tbody>
				...
				<tr>
					<td title="${d.senderDomain}">${d.senderDomain}</td>
					<td>${d.sentCount}</td>
					<td>${d.reachCount}</td>
					...
					<td class="edit">
						<ul class="f_ul">
							<li><a href="javascript:detail('${ctx}/senderDomain/detailList?senderEmail=${d.senderDomain}')">报告</a></li>
						</ul>
					</td>
				</tr>
			</c:forEach>
