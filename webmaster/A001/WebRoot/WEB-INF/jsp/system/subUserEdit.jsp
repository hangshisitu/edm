...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/system/subUserEdit.js?${version}"></script>
  </head>
  ...
  <body>
    <div id="main" class="clearfix" style="">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="edit_table">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="userId" name="userId" style="width:150px; height: 25px;border: #DCDCDC 1px solid;" maxlength="20" value="${user.userId}" readonly="readonly">
				...
				<tr>
					...
					<td>
						<input id="trueName" name="trueName" type="text" style="width:150px; height: 25px;border: #DCDCDC 1px solid;" maxlength="20" value="${user.trueName}">
				...
				<tr>
					<th width="20%">联系电话</th>
					<td>
						<input id="phone" name="phone" type="text" style="width:150px; height: 25px;border: #DCDCDC 1px solid;" maxlength="20" value="${user.phone}">
					</td>
				</tr>
				<tr>
					<th width="20%">状态</th>
					<td>
						<input type="radio" name="status" value="1" <c:if test="${user.status eq 1}">checked="checked"</c:if>/>正常
						<input type="radio" name="status" value="2" <c:if test="${user.status eq 2}">checked="checked"</c:if>/>冻结
					</td>
				</tr>
				</tbody>
		</table>
		...
		<input type="hidden" name="corpId" id="corpId" value="${user.corpId}">
