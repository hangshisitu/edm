...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="${ctx}/resources/script/system/subUserhistory.js?${version}"></script>
  </head>
  ...
  <body>
    <div id="main" class="clearfix" style="">
		...
		<form id="ListForm" action="${ctx}/history/subUserHistory" method="get">
		...
		<ul class="tab clearfix">
			...
			<sec:authorize ifAnyGranted="ROLE_ADM">
				...
				<li class="now"><a href="${ctx}/history/subUserHistory">子账号日志</a></li>
			</sec:authorize>
