...
//				}
	...
	public static void addTag(Map<Integer, List<DBObject>> tagMap, String email, long time) {
		BasicDBObject tag = addTag(email, time);
	...
	public static BasicDBObject addTag(String email, long time) {
