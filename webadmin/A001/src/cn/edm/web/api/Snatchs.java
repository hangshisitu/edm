...
public class Snatchs {

	private static Logger logger = LoggerFactory.getLogger(Snatchs.class);
	...
	public static String get(String url, String charset) {
		...
		try {
			...
			Integer[] codes = { HttpStatus.SC_MOVED_PERMANENTLY, HttpStatus.SC_MOVED_TEMPORARILY,
